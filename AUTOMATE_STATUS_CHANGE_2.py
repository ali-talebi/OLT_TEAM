"""
    ...
    Steps : 
        ...
        1 - export  TESTLINK_API_PYTHON_SERVER_URL TESTLINK_API_PYTHON_DEVKEY if System Platform Runnert is linux 
            ...
            if System platform Runner is Window 
                set TESTLINK_API_PYTHON_SERVER_URL=http://195.201.231.223:8080/lib/api/xmlrpc/v1/xmlrpc.php
                echo %TESTLINK_API_PYTHON_SERVER_URL%

                set TESTLINK_API_PYTHON_DEVKEY=2a40335f269615f7ebcef5af20141167
                echo %TESTLINK_API_PYTHON_SERVER_URL% 
